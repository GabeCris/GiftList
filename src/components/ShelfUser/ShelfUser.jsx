  ...
  return (
    <section className="shelfUser" onClick={() => navigate(`/user/${id}`)}>
      ...
      <a
        ...
        target={"_blank"}
        href={`https://wa.me/?text=Para%20acessar%20basta%20inserir%3A%20%0A%0ASeu%20nome%20de%20usu%C3%A1rio%3A%20*${userName}*%0ASeu%20c%C3%B3digo%20de%20acesso%3A%20*${pinCode}*%0A%0AOu%20acessar%20diretamente%20neste%20link%3A%0A%0Ahttps%3A%2F%2Flista-bruna-gabriel.netlify.app%2Flogin%2F%23${userName
          .toLowerCase()
          .replace(" ", "_")
          .replace(" ", "_")}`}
      >
